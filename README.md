...
Embed WideSutra scripture widgets on any website. **Zero dependencies**, Shadow DOM style isolation, 3 built-in themes (light, dark, sepia), and automatic daily verse updates. Each widget includes a "Powered by WideSutra" backlink.
...
<div data-widesutra="verse" data-ref="1:1" data-theme="light"></div>

<!-- Load the embed script once, anywhere on the page -->
<script src="https://cdn.jsdelivr.net/npm/widesutra-embed@1/dist/embed.min.js"></script>
```

That's it. The widget will load, fetch the verse from the WideSutra API, and render it with full style isolation.

## Widget Types

| Type | Usage |
|------|-------|
| Verse Card | `<div data-widesutra="verse" data-ref="..." data-theme="light"></div>` |
| Chapter Card | `<div data-widesutra="chapter" data-ref="..."></div>` |
| Comparison Card | `<div data-widesutra="compare" data-a="..." data-b="..."></div>` |
| Verse of the Day | `<div data-widesutra="votd" data-theme="light"></div>` |
| Search Box | `<div data-widesutra="search" data-placeholder="..."></div>` |

## Widget Options

| Attribute | Values | Default | Description |
|-----------|--------|---------|-------------|
| `data-widesutra` | verse, chapter, person, compare, votd, search | required | Widget type |
...
| `data-placeholder` | any string | "Search Sutra…" | Search box placeholder |
...
```html
<div data-widesutra="search" data-placeholder="Search Sutra…"></div>
<script src="https://cdn.jsdelivr.net/npm/widesutra-embed@1/dist/embed.min.js"></script>
```
...
- **CORS**: WideSutra API has CORS enabled for all origins
- **Caching**: Verse of the Day cached in localStorage (refreshes daily)
- **MutationObserver**: Works with dynamically added elements (SPAs)
- **Bundle size**: ~5KB gzipped

## Learn More About Sutra

Visit [widesutra.com](https://widesutra.com) — WideSutra is a comprehensive Sutra reference with full text, translations, and study tools.

- **API docs**: [widesutra.com/developers/](https://widesutra.com/developers/)
- **Widget builder**: [widget.widesutra.com](https://widget.widesutra.com)
- **npm package**: [npmjs.com/package/widesutra-embed](https://www.npmjs.com/package/widesutra-embed)
